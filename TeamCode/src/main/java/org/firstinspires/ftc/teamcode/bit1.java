...
@Autonomous(name="bit2200", group="TuringEcho")
public class bit1 extends  LinearOpMode {

    /* Declare OpMode members. */
    TuringEchoRobotHardware1 robot = new TuringEchoRobotHardware1();

    public void runOpMode() throws InterruptedException {robot.init(hardwareMap);
        waitForStart();
        forward1();
